...
Board [label="{Board|- width : int\l- height : int\l|+ canReset() : bool\l+ initialize()\l+ moveRequest(loc : RelativeCoord, r : Robot, rot : Rotation) : BoardResponse\l+ requestTilesExchange() : bool\l- calculateNewLocation(loc : RelativeCoord, r : Robot) :
AbsoluteCoord\l- getHint(r : Robot) : Hint\l- getValidTiles() : TilePair\l- reset()\l- saveLocation(loc : AbsoluteCoord, r : Robot)\l}"]
