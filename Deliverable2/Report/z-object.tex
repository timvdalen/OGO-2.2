...
We begin with a few axiomatic definitions. Then we give the long list of classes and how they are defined. The name of the dummy variables in the invariants is the begin letter of the name of the type.
...
\end{zpar} \\
terminate \sdef \mathbb{M}.terminate
\end{class}
